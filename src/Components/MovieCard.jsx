       ...
       {popupMessage && (
        <div className="custom-popup bg-red-600">
          ...
          data-testid="movie-poster" />
            ...
            <p className="flex gap-8 justify-between flex-row-reverse font-robo  items-center"><span className="flex items-center gap-1 "><GiTomato  className="text-xl text-red-600"/>{movie.popularity > 100 ? "100":Math.floor(movie.popularity)}%</span> <span className="flex items-center gap-1 "><FaImdb className="bg-[#F4C611]  text-black text-xl" /> {movie.vote_average}</span></p>
         <h3 
